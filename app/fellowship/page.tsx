...
/* Two-column section row: heading left, content right */
function SectionRow({
  heading,
  children,
}: {
  ...
  return (
    <section className="flex flex-col lg:flex-row gap-8 lg:gap-16 py-16 md:py-20 border-t border-white/10">
      {/* Left: heading column */}
...
export default function FellowshipPage() {
  return (
    <main className="min-h-screen relative bg-[#03396c] text-white font-poppins overflow-hidden selection:bg-white/20">
      ...
      {/* ── Page content — full-width with site inset padding ── */}
      <div className="relative z-10 pt-40 pb-28 px-[5%] sm:px-[4%] md:px-[3%] lg:px-[2.5%] xl:px-[2.25%]">
        {/* ── Hero ── */}
        <div className="pt-10 pb-16 md:pb-24 border-b border-white/10">
          ...
          <p className="text-base md:text-xl text-gray-300 font-light max-w-2xl mb-10 leading-relaxed">
            Supporting the next generation of VLSI testing researchers across
            India.
          </p>
        ...
        <section className="py-16 md:py-20 border-t border-white/10">
          <div className="mb-12">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold uppercase leading-none mb-4">
              Support Details
            </h2>
        ...
        {/* ── CTA ── */}
        <div className="pt-16 md:pt-24 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center gap-6">
          <Link href="/fellowship/register">
