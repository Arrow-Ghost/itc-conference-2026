      ...
      <div className="flex flex-col-reverse xl:flex-row gap-4 sm:gap-8 md:gap-10 xl:gap-14 w-full max-w-full">
        ...
        <div className="flex-1 flex flex-col gap-3 sm:gap-4 md:gap-5">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="bg-[#d9d9d9] rounded-[5px] px-3 py-3 sm:px-5 sm:py-4 md:px-5 md:py-4 text-black min-h-[120px] sm:min-h-[150px] xl:min-h-[165px] w-3/5 box-border mx-auto"
            >
